  ...
  const footerLinks = [
    {
      ...
      links: [
        ...
        { name: 'Cover Letters', href: '/cover-letter' },
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
            ...
            <div>
              ...
              <p className={`mb-4 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                Get the latest AI job trends and career advice delivered to your inbox.
              </p>
              {subscribed ? (
                <div className="text-success-600 dark:text-success-400 font-medium bg-success-100 dark:bg-success-900/30 p-3 rounded-lg">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-2">
                  <input
                    ...
                    } border focus:ring-1 focus:ring-primary-500 focus:outline-none`}
